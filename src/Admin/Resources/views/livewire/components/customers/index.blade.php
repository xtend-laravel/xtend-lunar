<div class="space-y-4 flex-col">
    ...
    <div>
        <div class="gap-x-8 flex flex-row">
            <div class="basis-1/4">
                <div class="h-24 p-4 bg-white rounded-lg flex items-center">
                    <div class="w-12 h-12 ml-2 bg-blue-200 rounded-full flex items-center justify-center">
                    ...
                    <div class="ml-4 flex items-center">
                        <div>
                            <strong class="text-lg font-bold">{{ $this->newProductsCount ?? 0 }}</strong>
                            <span class="text-xs block">{{ __('adminhub::catalogue.customers.index.title') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="basis-1/4">
                <div class="h-24 p-4 pr-0 bg-white rounded-lg flex items-center">
                    <div class="w-12 h-12 ml-2 rounded-full bg-amber-100 flex items-center justify-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12 2C6.579 2 2 6.579 2 12C2 17.421 6.579 22 12 22C17.421 22 22 17.421 22 12C22 6.579 17.421 2 12 2ZM12 7C13.727 7 15 8.272 15 10C15 11.728 13.727 13 12 13C10.274 13 9 11.728 9 10C9 8.272 10.274 7 12 7ZM6.894 16.772C7.791 15.452 9.287 14.572 11 14.572H13C14.714 14.572 16.209 15.452 17.106 16.772C15.828 18.14 14.015 19 12 19C9.985 19 8.172 18.14 6.894 16.772Z"
                    ...
                    <div class="ml-4 flex items-center">
                        <div>
                            <strong class="text-lg font-bold">{{ $this->returningCustomersPercent ?? 0 }}%</strong>
                            <span
                                class="text-xs block">{{ __('adminhub::catalogue.customer.dashboard.returning_customers') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="basis-1/4">
                <div class="h-24 p-4 pr-0 bg-white rounded-lg flex items-center">
                    <div class="w-12 h-12 ml-2 bg-red-100 rounded-full flex items-center justify-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="ml-4 flex items-center">
                        <div>
                            <strong class="text-lg font-bold">{{ $this->orderTotal?->formatted ?? 0 }}</strong>
                            <span
                                class="text-xs block">{{ __('adminhub::catalogue.customer.dashboard.turnover') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="basis-1/4">
                <div class="h-24 p-4 pr-0 bg-white rounded-lg flex items-center">
                    <div class="w-12 h-12 ml-2 rounded-full bg-indigo-50 flex items-center justify-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="ml-4 flex items-center">
                        <div>
                            <strong class="text-lg font-bold">{{ $this->orderCount ?? 0 }}</strong>
                            <span
                                class="text-xs block">{{ __('adminhub::catalogue.customer.dashboard.no_of_orders') }}</span>
                        </div>
                    </div>
                </div>
            </div>
