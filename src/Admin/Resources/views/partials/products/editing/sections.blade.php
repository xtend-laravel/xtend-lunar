<div class="flex items-center gap-4">
    <a href="{{ route('hub.products.index') }}"
        class="rounded bg-gray-50 text-gray-600 hover:bg-indigo-500 hover:text-white"
        title="{{ __('adminhub::catalogue.products.show.back_link_title') }}">
        <x-hub::icon ref="chevron-left" style="solid" class="h-8 w-8" />
    </a>
...
<div class="mt-8 pb-24 lg:flex lg:items-start lg:gap-8">
    <div class="space-y-6 lg:flex-1">
        <div class="space-y-6">
            ...
            @if ($product->id)
                <div class="rounded border border-red-300 bg-white shadow">
                    <header class="rounded-t border-b border-red-300 bg-white px-6 py-4 text-red-700">
