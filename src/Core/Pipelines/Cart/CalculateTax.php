...
namespace Xtend\Extensions\Lunar\Core\Pipelines\Cart;
...
class CalculateTax
{
    ...
    public function handle(Cart $cart, Closure $next)
    {
        ...
        foreach ($cart->lines as $cartLine) {
            ...
            $total = (int)ceil(($subTotal + $taxTotal) / 1000) * 1000;
            $cartLine->total = new Price($total, $cart->currency, $unitQuantity);
        }
